...
| Name                                   | Description                                                                                                                                                                                                                                                                                                              | Type       | Value             |
| -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- | ----------------- |
| `metric`                               | Read-load signal for autoscaling.                                                                                                                                                                                                                                                                                        | `string`   | `{}`              |
...
| `autoscaling.target`                   | Target read load per read-serving replica (unit depends on `metric`: active connections, or CPU millicores).                                                                                                                                                                                                             | `quantity` | `150`             |
